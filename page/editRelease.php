                    ...
                    <div class="level title">
                        ...
                        <div class="form-change-pass user-form">
							...
							<div class="field">
                                ...
                                <p class="control">
                                    <input class="input" type="time" id="birthday1" name="birthday1" value="<?=$arr_1[0]?>" >
                                </p>
                            </div>
							...
							<div class="field">
                                <p class="txt">Chap</p>
                                <p class="control">
                                    <input class="input" type="text" id="nameChap" name="nameChap" value="<?=$arr_1[1]?>">
                                </p>
                            </div>
							<div class="field">
								...
								<select id="Type" class="form-control">
								   ...
								   if($arr_1[2]==""){
								       ...
								       echo '<option value="hot" selected>Hot</option>'; 
								   }
								   ?>					
								</select>
                            </div>								
                            ...
                            <div class="field">
                                <p class="control">
                                    <button class="button is-danger"  id="editRelease" data-id="<?=$id?>">Lưu</button>
                                </p>
                            </div>
...
var linkOption12=<?php echo json_encode($linkOption1)?>;
        $(document).ready(function(){
            ...
            $('#editRelease').click(function(){
				...
				var id=$('#editRelease').attr("data-id");
                var type = $('#Type').val();
			   ...
			   $.ajax({     
			   url:linkOption12+'ajax/release/edit.php',
			   type:'POST',
			   cache:false,
			   data:{'id':id,'date':date,'time':time,'idStory':idStory,'nameChap':nameChap,'type':type},
			   success:function(kq){
				   console.log(kq);
				   //location.reload();
			   }
