...
?>   
    ...
    <div class="container">
        <div class="messages columns">
			...
			$typeLeftHeader="listGenre";
			require_once('header/headerLeft.php');
			?>  
			<div class="column columns">				
                <div class="user-main column" style="overflow: scroll;">				  
                    <div class="level title">
                        <p class="level-left has-text-weight-bold">Danh sách Danh mục</p>
						<p class="level-left has-text-weight-bold"><a href="addGenre.php"><i class="fas fa-plus fa-2x"></i></a></p>						
                    </div>                
					<div class="field">
						<p class="txt">Name</p>
						<p class="control">
							<input  class="input" type="text" id="SearchGenre" name="last_name" >
						</p>
					</div>
					<div class="field" >
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   ...
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 ...
								 html1+='<td>'+k[0][i].Title+'</td>';
								
								 html1+='<td><a href="editGenre.php?idGenre='+k[0][i].Id+'"><i class="fas fa-edit"></i></a></td>';
html1+='<td><a href="javascript:void(0)"  data-id="'+k[0][i].Id+'" data-name="'+k[0][i].Name+'" class="btnDelete"><i class="fas fa-trash-alt"></i></a></td>';
