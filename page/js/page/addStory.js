	 ...
	 if (confirm("Bạn chắc muốn lưu!!!") == true) {	  
	  if(Avatar!=undefined && Name!=""){
		 $.ajax({     
	       ...
	       type:'POST',
	       cache:false,
	       data:{'Gender':Gender,'URL1':URL1,'URL2':URL2,'Name':Name,'NameOther':NameOther,'Status':Status,'Content':Content,'Avatar':Avatar,'Badge':Badge,'Waning':Waning,'Author':Author,'Genre':Genre.toString(),'Country':Country,'tempStory':tempStory},
	       success:function(kq){
	 ...
	 if (confirm("Bạn chắc muốn lưu!!!") == true) {	
	  if(Avatar!=undefined && Name!=""){
		 $.ajax({     
	       ...
	       type:'POST',
	       cache:false,
	       data:{'Gender':Gender,'URL1':URL1,'URL2':URL2,'Id':Id,'Name':Name,'NameOther':NameOther,'Status':Status,'Content':Content,'Avatar':Avatar,'Badge':Badge,'Waning':Waning,'Author':Author,'Genre':Genre.toString(),'Country':Country,'tempStory':tempStory},
	       success:function(kq){
