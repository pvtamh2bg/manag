...
$(document).ready(function () {
    ...
    if (flac_coment == 0) {
      ...
      $.ajax({
        ...
        success: function (kq) {
          ...
          if (o.Title == "Ẩn Danh") {
            Title1 =
              "<span class='title-user-comment title-hidden'>" +
              o.Title +
              "</span>";
            $("#tam-thoi").after(
              "<div id='comment-form-levels" +
                o.Id +
                "' class='comment-main-replys'><article class='info-comment child_" +
                o.Id +
                " parent_0 comment-main-level' id='c" +
                o.Id +
                "'><div class='outsite-comment comment-main-level'><figure class='avartar-comment'><img src='" +
                o.Avartar +
                "' alt='" +
                o.Name +
                "'></figure><div class='item-comment'><div class='outline-content-comment'><div><strong>" +
                o.Name +
                "</strong>" +
                Title1 +
                "<span class='time'>" +
                o.DateComment +
                "</span></div><div class='content-comment'><strong></strong>" +
                o.Content +
                "</div></div><div class='action-comment'><span  class='like-comment' data-id='lc" +
                o.Id +
                "'><i class='fas fa-thumbs-up'></i><span id='lc" +
                o.Id +
                "' class='total-like-comment' data-like='c" +
                o.Id +
                "'>" +
                o.Likes +
                "</span></span><span class='reply-comment' data-parent='0' aa00='0' aa0='c" +
                o.Id +
                "' aa4='" +
                o.Id +
                "' aa5='" +
                ...
                "' email='" +
                o.IdUser +
                "'><i class='far fa-comment'></i> Trả lời</span></div></div></div></article></div>"
            );
            ...
            $("#tam-thoi").after(
              "<div id='comment-form-levels" +
                ...
                "' email='" +
                o.IdUser +
                "'><i class='far fa-comment'></i> Trả lời</span><span class='remove_comnent'  data-bookid='c" +
                o.Id +
                "' title='Xoá'><i class='fa fa-trash' aria-hidden='true'></i> Xoá</span></div></div></div></article></div>"
            );
          } else {
            $("#content_comment").val("");
          }
  ...
  $(".list-comment").on("click", ".reply-comment", function () {
    ...
    $("#" + Id).after(
      "<div class='form-comment reply_comment reply_" +
        Id +
        " reply-ccc' ><div class='message-content'><div class='input-comment'><span class='col-md-6 col-sm-6 col-xs-12 text-center'><input  class='input' id='name_comments' type='text' placeholder='Name' value='" +
        name_comment +
        "'></span><span class='col-md-6 col-sm-6 col-xs-12 text-center'><input  class='input' id='email_comments' type='email' placeholder='Email' value='" +
        m +
        "'></span></div><div class='mess-input'><textarea class='textarea' placeholder='Nội dung bình luận' id='content_comment_s'></textarea><button id='emoji_2' type='submit' class='click_emoji'></button><button type='submit' class='submit_comment' aa00='0' aa0='" +
        Id +
        "' aa4='" +
        Id +
        "' aa5='" +
    ...
    $("#content_comment_s").focus();IdStory
    ...
    if (flac_coment == 0) {
      $.ajax({
        ...
        success: function (kq) {
          ...
          var Title1 = "";
          var xoa =
            "<span class='remove_comnent'  data-bookid='r" +
            o.Id +
            "' title='Xoá'><i class='fa fa-trash' aria-hidden='true'></i> Xoá</span>";
          if (o.Title == "Ẩn Danh") {
            Title1 =
              "<span class='title-user-comment title-hidden'>" +
              o.Title +
            ...
            $("#comment-form-levels" + o.id2).append(
              "<article class='info-comment child_" +
                o.Id +
                " parent_" +
                o.IdComment +
                " reply-list' id='r" +
                o.Id +
                "'><div class='outsite-comment reply-list'><figure class='avartar-comment'><img src='" +
                o.Avartar +
                "' alt='" +
                o.Name +
                "'></figure><div class='item-comment'><div class='outline-content-comment'><div><strong>" +
                ...
                "<span class='time'>" +
                o.DateRelay +
                "</span></div><div class='content-comment'><strong>" +
                o.NameRelay1 +
                "</strong> " +
                o.Content +
                "</div></div><div class='action-comment'><span class='like-comment' data-id='lr" +
                o.Id +
                "'><i class='fas fa-thumbs-up'></i> <span id='lr" +
                o.Id +
                "' class='total-like-comment' data-like='r" +
                o.Id +
                "'>" +
                o.Likes +
                "</span></span><span class='reply-comment' aa00='1' aa0='r" +
                o.Id +
                "' aa4='" +
                o.IdComment +
                "' aa5='" +
                ...
                "' email='" +
                IdUser +
                "'><i class='far fa-comment'></i> Trả lời</span></div></div></div></article>"
            );
          } else if (o.Title == "Thành Viên") {
            Title1 =
              "<span class='title-user-comment title-member'>" +
    ...
    !(function (e, t) {
      ...
      if (n) {
        var i = n.scrollTop,
          o = 0,
          s =
            n.selectionStart || "0" == n.selectionStart
              ? "ff"
        ...
        if (((n.value = a + t + l), (o += t.length), "ie" == s)) {
          ...
          c.moveStart("character", -n.value.length),
            c.moveStart("character", o),
            c.moveEnd("character", 0),
            c.select();
        } else
          "ff" == s &&
            ((n.selectionStart = o), (n.selectionEnd = o), n.focus());
        n.scrollTop = i;
      }
    })($(emoji_1_2).val(), t);
  ...
  function load_comments1() {
    ...
    if (count_class.length != 0) {
      var IdDiv = document.getElementsByClassName("comment-main-replys")[
        count_class.length - 1
      ].id;
      ...
      success: function (kq) {
        ...
        function myFunction3(str, arr1, arr2) {
          ...
          for (var i = 0; i < arr1.length; i++) {
            ...
            if (k.indexOf(arr1[i]) >= 0) {
              k = k.replace(
                re,
                "<img src='" + arr2[i] + "' class='emoji_comment'>"
              );
            }
          }
          return k;
        ...
        for (var i = 0; i < f_c.length; i++) {
          ...
          if (!myElement) {
            ...
            if (m == f_c[i].IdUser)
              xoa2 =
                "<span class='remove_comnent'  data-bookid='c" +
                f_c[i].Id +
                "' title='Xoá'><i class='fa fa-trash' aria-hidden='true'></i> Xoá</span>";
            ...
            if (f_c[i].Title == "Ẩn Danh") {
              ...
              $(".list-comment").append(
                "<div id='comment-form-levels" +
                  ...
                  cccc1[i] +
                  "</span></div><div class='content-comment'><strong></strong>" +
                  myFunction3(f_c[i].Content, ej_c1, ej_p1) +
                  "</div></div><div class='action-comment'> <span class='like-comment' data-id='lc" +
                  f_c[i].Id +
                  "'><i class='fas fa-thumbs-up'></i>&nbsp;<span id='lc" +
                  f_c[i].Id +
              ...
              if (f_c[i].Id == f_r[j].IdComment) {
                ...
                if (f_r[j].Title == "Ẩn Danh") {
                  Title2 =
                    ...
                    f_r[j].Title +
                    "</span>";
                  $("#comment-form-levels" + f_c[i].Id).append(
                    "<article class='info-comment child_" +
                      f_r[j].Id +
                      " parent_" +
                      f_r[j].IdReply +
                      ...
                      f_r[j].NameComment +
                      "</strong> " +
                      myFunction3(f_r[j].Content, ej_c1, ej_p1) +
                      "</div></div><div class='action-comment'><span class='like-comment' data-id='lr" +
                      f_r[j].Id +
                      "'><i class='fas fa-thumbs-up'></i> <span id='lr" +
                      f_r[j].Id +
