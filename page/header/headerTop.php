    ...
    <div class="container">
        <div class="level">
            <div class="level-left pc">
                <span class="logo">
                    <a href="../">Thần Kinh Các</a>
                </span>
                <!-- /.logo -->
                <div class="top-search">
                    <input type="text" class="text-search" placeholder="Nhập từ khoá">
                ...
                <div class="top-buttons has-login">
                    ...
                    <div class="notify user center">
                        ...
                        <ul class="user-links">
                            ...
                            <li>
                                <a href=""><i class="fas fa-heart"></i> The story is following</a>
                            </li>
                            <li>
...
<div class="modal login-modal">
    ...
    <div class="modal-content">
        <span class="top-caption">
            ...
            đến giờ đọc truyện cứ vào iTruyenTranh
        </span>
        <div>
            <!-- /.top-caption -->
            ...
            <div class="tabs-contents">
                <div class="login-section">
                    <div class="form-login">
                        ...
                        <button type="submit" class="button_login btn btn-lg">Log in</button>
