...
<body oncontextmenu="return false;">
	...
	<div class="outsite ">
		...
		<section class="main-content index">
			<div class="ranking-hot" style="float:right;">
				<?php require_once('page/hot.php'); ?>
			</div>
			<div class="container">
				<div class="latest">
					...
					<div class="has-text-centered">
						<a href="<?php echo $linkOption; ?>truyen-tranh-hay/trang-2.html" class="view-more-btn">See More Listings
							<span> → </span></a>
					</div>
				</div>
			</div>
					...
					<div class="level-left">
						<div class="col-sm-4 text-center" itemscope="" itemtype="http://schema.org/Organization">
							<a itemprop="url" href="index.html">
								<img itemprop="logo" width="100" src="<?= $linkOption ?>page/frontend/images/web_logo.png"
									alt="<?= $linkOption ?>">
							</a>
						</div>
						<div class="text-footer">Copyright © 2023 - Email: contact@
							<?= $domain ?>
						</div>
					</div>
