    ...
    <div class="container">
        <div class="level">
            <div class="level-left pc">
                <span class="logo">
                    <a href="<?= $linkOption?>">Truyen QQ</a>
                </span>
                    <!-- /.logo -->
                    <div class="top-search">
                        <input type="text" class="text-search" input-Link="<?= $linkOption?>" placeholder="Bạn cứ nhập từ khoá, còn lại để qq lo"/>
        ...
        <nav class="navbar">
            <div class="navbar-menu">
                <div class="navbar-start">
                    ...
                    <a rel="nofollow" href="#" target="" class="navbar-item">Tuyển Nhân Sự</a>
                </div>
            </div>
        </nav>
    </div>
