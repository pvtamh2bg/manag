  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  ?>
                  <div class="img"><img id="idAvatar" class="image-avatar" src="<?php echo $linkOption1 . $path; ?>"
                      alt="" /></div>
        ...
        <div class="row">
          <div class="col-12">
            <button type="button" class="btn btn-success" id="editStory" data-id="<?php echo $id ?>"
              src-image="<?php echo $path ?>">Lưu</button>
