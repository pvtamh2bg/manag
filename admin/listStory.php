      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
            ...
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" id="SearchStory">
			  ...
			  var html1="";
			    html1+='<table class="table  table-striped projects">';
				   ...
				   for(var i=0;i<k[0].length;i++)
					...
					html1+=' <a data-id="'+k[0][i].Id+' class="btn btn-info btn-sm hide_view" href="javascript:void(0)"><i id="'+k[0][i].Id+'" class="fa fa-eye-slash" aria-hidden="true"></i></a>';
							     else
								 html1+=' <a data-id="'+k[0][i].Id+'" class="btn btn-info btn-sm hide_view" href="javascript:void(0)"><i id="'+k[0][i].Id+'" class="fa fa-eye" aria-hidden="true"></i></a>';
