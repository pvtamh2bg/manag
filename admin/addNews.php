...
<?php
	...
	$arr_story=$db->GetStoryJoinSlider();
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
			    ...
			    <input type="text" id="Name" class="form-control" placeholder="Nhập tên tiêu đề bài viết">
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                   <button type="button" class="btn btn-success" id="addNews" src-image="" src-path="">Lưu</button>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
...
$(document).ready(function(){
	...
	$("#addNews").click(function(){
	  ...
	  $.ajax({     
	   ...
	   type:'POST',
	   cache:false,
	   data:{'user':user,'path':path,'content':content,'name':name},
	   success:function(kq){
		      var o = JSON.parse(kq);
		       if(o.Error=="Thêm thành công"){
