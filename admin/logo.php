          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="field">
                   <p class="txt">Logo</p>
                    <p class="control">
                        <input class="form-control input" type="text" placeholder="Ảnh" id="logo" name="logo" value="<?=$logo[1]?>">
                    </p>						
                ...
                <div class="field">
                    ...
                    <p class="control">
                        <input class="form-control input" type="text" placeholder="Ảnh" id="logo_on" name="logo_on" value="<?=$logo[2]?>">
                    </p>
