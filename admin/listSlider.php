    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Dach sách tác giả</h3>
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   ...
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 html1+='<td><img src="'+linkOption1+k[0][i].Path+'" style="width:70px;height:50px;"/></td>';
