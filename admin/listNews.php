...
<div class="wrapper">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
            ...
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" id="SearchAuthor">
    ...
    <div class="sidebar">
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
          <input class="form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search" id="SearchAuthor">
          <div class="input-group-append">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
           <a href="addNews.php"><button type="button" class="button is-danger btn btn-success"  title="Collapse">Thêm bài viết</button></a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="https://itruyentranh.net/">itruyentranh.net</a>.</strong> All rights reserved.
  </footer>
...
function paginationEvent(per_page=5,page=1){
	  var key=document.getElementById("SearchAuthor").value;
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   ...
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 html1+='<td><img src="'+linkOption1+k[0][i].Img+'" style="width:70px;height:50px;"/></td>';
								 html1+='<td>'+k[0][i].Name+'</td>';							
								 html1+='<td><a href="editNews.php?id='+k[0][i].Id+'"><i class="fas fa-edit"></i></a></td>';
								 html1+='<td><a href="javascript:void(0)"  data-src="'+k[0][i].Img+'" data-id="'+k[0][i].Id+'" class="btnDelete"><i class="fas fa-trash-alt"></i></a></td>';	
							   html1+='</tr>';
...
$(document).ready(function(){
  ...
  $("#listNews").on('click', '.btnDelete', function() {
